...
{ "folke/trouble.nvim", lazy = false, opts = {}, cmd = "Trouble", dependencies = { 'nvim-tree/nvim-web-devicons' } },
...
{ "rcarriga/nvim-dap-ui", version="v4.*", dependencies = {"mfussenegger/nvim-dap", "nvim-neotest/nvim-nio"} },
